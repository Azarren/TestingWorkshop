Given('I navigate to the homepage (mandatory)') do
  visit 'https://www.gov.uk/calculate-your-holiday-entitlement'
  sleep 1
end

And('I should see the homepage (mandatory)') do
...
When ("I click on the 'Start now' button (mandatory)") do
  click_link('Start now')
end

And("I select the option no for working irregular hours (mandatory)") do
...
And ('I select the option hours worked per week (mandatory)') do
...
And ('I select the option for a full leave year (mandatory)') do
...
And ('I input 37.5 hours worked per week (mandatory)') do
...
And ('I input 5 days worked per week (mandatory)') do
...
Then ('I should see the correct submitted answers (mandatory)') do
...
And ('I should see the total entitlement hours (mandatory)') do
